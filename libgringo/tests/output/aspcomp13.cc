...
class TestAspcomp13 : public CppUnit::TestFixture {
    CPPUNIT_TEST_SUITE(TestAspcomp13);
        ...
        CPPUNIT_TEST(test_aspcomp2013_05);
        CPPUNIT_TEST(test_aspcomp2013_06);
        CPPUNIT_TEST(test_aspcomp2013_07);
        CPPUNIT_TEST(test_aspcomp2013_08);
        CPPUNIT_TEST(test_aspcomp2013_09);
        CPPUNIT_TEST(test_aspcomp2013_10);
        CPPUNIT_TEST(test_aspcomp2013_13);
        CPPUNIT_TEST(test_aspcomp2013_14);
        CPPUNIT_TEST(test_aspcomp2013_15);
        CPPUNIT_TEST(test_aspcomp2013_16);
        CPPUNIT_TEST(test_aspcomp2013_17);
        CPPUNIT_TEST(test_aspcomp2013_19);
        CPPUNIT_TEST(test_aspcomp2013_20);
        CPPUNIT_TEST(test_aspcomp2013_21);
        CPPUNIT_TEST(test_aspcomp2013_22);
        CPPUNIT_TEST(test_aspcomp2013_23);
        CPPUNIT_TEST(test_aspcomp2013_24);
...
public:
    ...
    void test_aspcomp2013_01();
    void test_aspcomp2013_02();
    void test_aspcomp2013_04();
    void test_aspcomp2013_05();
    void test_aspcomp2013_06();
    void test_aspcomp2013_07();
    void test_aspcomp2013_08();
    void test_aspcomp2013_09();
    void test_aspcomp2013_10();
    void test_aspcomp2013_13();
    void test_aspcomp2013_14();
    void test_aspcomp2013_15();
    void test_aspcomp2013_16();
    void test_aspcomp2013_17();
    void test_aspcomp2013_18();
    void test_aspcomp2013_19();
    void test_aspcomp2013_20();
    void test_aspcomp2013_21();
    void test_aspcomp2013_22();
    void test_aspcomp2013_23();
    void test_aspcomp2013_24();
    void test_aspcomp2013_25();
    void test_aspcomp2013_26();
    void test_aspcomp2013_27();

    virtual ~TestAspcomp13();
};

// }}}

// {{{ definition of TestAspcomp13
...
void TestAspcomp13::test_aspcomp2013_01() {
    // Author: Martin Lackner, Andreas Pfandler
    CPPUNIT_ASSERT_EQUAL(
        S("[[solution(1,3),solution(2,4),solution(3,2)]]"),
        IO::to_string(solve(
            "% instance\n"
            "t(1,5).\n"
            "t(2,3).\n"
...
// }}}
// {{{ N04 Connected Maximum-density Still Life

void TestAspcomp13::test_aspcomp2013_04() {
...
void TestAspcomp13::test_aspcomp2013_05() {
    // Author: Christian Drescher
    CPPUNIT_ASSERT_EQUAL(
        S(
...
// }}}
// {{{ N06 Bottle Filling Problem

void TestAspcomp13::test_aspcomp2013_06() {
    // Author: Wolfgang Faber
    CPPUNIT_ASSERT_EQUAL(
        S("[[filled(1,1),filled(1,2)]]"),
        IO::to_string(solve(
            "% instance\n"
            "\n"
            "xsucc(1,2). ysucc(1,2).\n"
...
void TestAspcomp13::test_aspcomp2013_09() {
    ...
    CPPUNIT_ASSERT_EQUAL(
        S(
            ...
            "[go(green,south,-1,3),go(green,south,3),go(red,east,1,2),go(red,east,2),go(red,south,-1,5),go(red,south,5),go(yellow,east,1,4),go(yellow,east,4),go(yellow,west,1),go(yellow,west,1,1)]]"),
        IO::to_string(solve(
            "% instance\n"
            "\n"
            "dim(1). dim(2). dim(3).\n"
...
void TestAspcomp13::test_aspcomp2013_10() {
    ...
    CPPUNIT_ASSERT_EQUAL(
        S(
            ...
            "[position(n1,1),position(n10,4),position(n11,1),position(n12,3),position(n13,8),position(n14,9),position(n15,5),position(n16,6),position(n17,2),position(n18,7),position(n19,3),position(n2,3),position(n20,7),position(n21,1),position(n22,2),position(n23,8),position(n24,9),position(n25,5),position(n26,4),position(n27,6),position(n3,7),position(n4,2),position(n5,8),position(n6,9),position(n7,6),position(n8,4),position(n9,5)]]"
            ),
        IO::to_string(solve(
            "% instance\n"
            "\n"
...
void TestAspcomp13::test_aspcomp2013_13() {
    ...
    CPPUNIT_ASSERT_EQUAL(S("[-:56:94-111: warning: atom is undefined:\n  checking_solution\n,-:51:76-93: warning: atom is undefined:\n  #not checking_solution\n]"), IO::to_string(msg));
}


// }}}
// {{{ O14 Weighted-Sequence Problem

void TestAspcomp13::test_aspcomp2013_14() {
    ...
    CPPUNIT_ASSERT_EQUAL(
        S(
           ...
           "[leafPos(1,2),leafPos(2,1),leafPos(3,0),posColor(1,red),posColor(2,red)]]"
            ),
        IO::to_string(solve(
            "% instance\n"
            "\n"
...
void TestAspcomp13::test_aspcomp2013_15() {
...
// }}}
// {{{ O16 Incremental Scheduling

void TestAspcomp13::test_aspcomp2013_16() {
    // Author: Marcello Balduccini, Yuliya Lierler*
    Gringo::Test::Messages msg;
    CPPUNIT_ASSERT_EQUAL(
        S(
    ...
    CPPUNIT_ASSERT_EQUAL(S("[-:34:83-100: warning: atom is undefined:\n  #not checking_solution\n,-:33:51-68: warning: atom is undefined:\n  #not checking_solution\n]"), IO::to_string(msg));
}

// }}}
// {{{ N17 Qualitative Spatial Reasoning

void TestAspcomp13::test_aspcomp2013_17() {
    ...
    CPPUNIT_ASSERT_EQUAL(
        S(
            ...
            "[label(0,1,rpi),label(0,2,rpi),label(1,2,rd)]]"
        ),
        IO::to_string(solve(
            "% instance\n"
            "\n"
...
// }}}
// N18 too big
// {{{ N19 Abstract Dialectical Frameworks Well-founded Model
...
void TestAspcomp13::test_aspcomp2013_20() {
    ...
    CPPUNIT_ASSERT_EQUAL(
        S(
            ...
            "[move(x1y3,x2y3,3),move(x2y1,x1y1,8),move(x2y2,x2y3,1),move(x2y3,x1y3,2),move(x2y3,x3y3,4),move(x3y1,x2y1,7),move(x3y2,x3y1,6),move(x3y3,x3y2,5)]]"
            ),
        IO::to_string(solve(
            "% instance\n"
            "\n"
...
// }}}
// {{{ N21 Complex Optimization of Answer Sets

void TestAspcomp13::test_aspcomp2013_21() {
    ...
    CPPUNIT_ASSERT_EQUAL(
        S(
            ...
            "[hold(atom(a)),hold(atom(d)),hold(atom(p)),hold(atom(r)),hold(conjunction(0)),hold(conjunction(1)),hold(conjunction(3)),hold(conjunction(4))]]"
            ),
        IO::to_string(solve(
            "% instance\n"
            "\n"
...
// }}}
// {{{ N22 Knight Tour with Holes

void TestAspcomp13::test_aspcomp2013_22() {
...
// }}}
// {{{ O23 Maximal Clique Problem

void TestAspcomp13::test_aspcomp2013_23() {
...
void TestAspcomp13::test_aspcomp2013_24() {
    // Author: Carmine Dodaro, Giovambattista Ianni, Martin Gebser*
    CPPUNIT_ASSERT_EQUAL(
        S(
            "[[push(1,w,1),push(2,n,2)],[push(1,w,1),push(3,s,2)]]"
        ),
        IO::to_string(solve(
            "% instance\n"
            "\n"
...
// }}}
// {{{ O25 Minimal Diagnosis

void TestAspcomp13::test_aspcomp2013_25() {
...
void TestAspcomp13::test_aspcomp2013_26() {
    // Author: Gayathri Namasivayam, Miroslaw Truszczynski, Shaden Smith, Alex Westlund
    CPPUNIT_ASSERT_EQUAL(
        S(
            "[[put(0,3,9),put(1,2,8),put(2,8,9)],[put(0,4,9),put(1,2,8),put(2,8,9)]]"
        ),
        IO::to_string(solve(
            "% instance\n"
            "\n"
...
void TestAspcomp13::test_aspcomp2013_27() {
...
TestAspcomp13::~TestAspcomp13() { }

// }}}

CPPUNIT_TEST_SUITE_REGISTRATION(TestAspcomp13);
