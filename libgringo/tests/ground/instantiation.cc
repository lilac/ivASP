...
// {{{ declaration of TestInstantiation
...
class TestInstantiation : public CppUnit::TestFixture {
    CPPUNIT_TEST_SUITE(TestInstantiation);
        ...
        CPPUNIT_TEST(test_min_fail);
        CPPUNIT_TEST(test_min_true);
        CPPUNIT_TEST(test_min_open);
        CPPUNIT_TEST(test_rec_count);
        CPPUNIT_TEST(test_assign_count);
        CPPUNIT_TEST(test_assign_sum);
        CPPUNIT_TEST(test_assign_sump);
        CPPUNIT_TEST(test_assign_min);
        CPPUNIT_TEST(test_assign_max);
        CPPUNIT_TEST(test_conj);
...
public:
    ...
    std::string gbie() const;
    std::string gbie1() const;
    std::string gbie2() const;
    std::string strategicA1() const;
    std::string strategicB1() const;
    ...
    void test_assign_sum();
    void test_assign_sump();
    void test_assign_min();
    void test_assign_max();
    void test_conj();
    void test_rec_conj();
    void test_meta();
    void test_head();
    ...
    virtual ~TestInstantiation();
};

// }}}

// {{{ definition of TestInstantiation

using namespace Gringo::IO;

void TestInstantiation::setUp() {
}

void TestInstantiation::tearDown() {
}

std::string TestInstantiation::ground(std::string const &str, std::initializer_list<std::string> filter) {
    std::stringstream ss;
...
//    std::cerr << prg << std::endl;
    Program gPrg(prg.toGround(out.domains));
//    std::cerr << gPrg << std::endl;
    gPrg.ground(out);
...
void TestInstantiation::test_bodyaggregate() {
    CPPUNIT_ASSERT_EQUAL(
        std::string(
            "company(c1).\n" "company(c2).\n" "company(c3).\n" "company(c4).\n"
            "controls(c1,c2).\n" "controls(c1,c3).\n" "controls(c1,c4).\n" "controls(c3,c4).\n"
...
void TestInstantiation::test_bodyaggregate2() {
    CPPUNIT_ASSERT_EQUAL(
        std::string(
            "company(c1).\n" "company(c2).\n" "company(c3).\n" "company(c4).\n"
...
void TestInstantiation::test_min_fail() {
...
void TestInstantiation::test_min_open() {
    CPPUNIT_ASSERT_EQUAL(
        std::string(
            ...
            "mmin(11):-1<=#min{1:p(1);2:p(2)}<=1.\n"
            "mmin(12,1):-0<=#min{0:r(1)}<=0.\n"
            "mmin(12,2):-1<=#min{1:r(2)}<=1.\n"
...
void TestInstantiation::test_assign_min() {
    CPPUNIT_ASSERT_EQUAL(
        std::string(
            "p(-1).\n"
            "p(-2).\n"
...
void TestInstantiation::test_assign_max() {
    CPPUNIT_ASSERT_EQUAL(
        std::string(
            "p(-1).\n"
            "p(-2).\n"
...
void TestInstantiation::test_assign_sump() {
    Gringo::Test::Messages msg;
    CPPUNIT_ASSERT_EQUAL(
        std::string(
            "p(-1).\n"
...
void TestInstantiation::test_assign_count() {
    CPPUNIT_ASSERT_EQUAL(
        std::string(
            "p(1).\n"
            "p(2).\n"
...
void TestInstantiation::test_assign_sum() {
    CPPUNIT_ASSERT_EQUAL(
        std::string(
            "p(1).\n"
            "p(2).\n"
...
void TestInstantiation::test_rec_count() {
    CPPUNIT_ASSERT_EQUAL(
        std::string(
            "edge(1,3).\n" "edge(2,3).\n" "edge(3,4).\n" "edge(3,6).\n" "edge(4,5).\n" "edge(4,6).\n" "edge(6,7).\n" "edge(6,8).\n"
            "inlink(3,2).\n" "inlink(4,3).\n" "inlink(6,4).\n"
...
std::string TestInstantiation::gbie() const {
    return
...
std::string TestInstantiation::gbie1() const {
    return
        "char(p,1).\n"  "char(0,2).\n"  "char(m,3).\n"  "char(o,4).\n"
        "char(o,5).\n"  "char(6,6).\n"  "char(m,7).\n"  "char(7,8).\n"
        "char(p,9).\n"  "char(3,10).\n" "char(p,11).\n" "char(o,12).\n"
...
std::string TestInstantiation::gbie2() const {
    return
        "char(o,1).\n"  "char(m,2).\n"  "char(o,3).\n"  "char(p,4).\n"
        "char(1,5).\n"  "char(m,6).\n"  "char(o,7).\n"  "char(m,8).\n"
        "char(2,9).\n"  "char(c,10).\n" "char(p,11).\n" "char(7,12).\n"
...
void TestInstantiation::test_rec_conj() {
    CPPUNIT_ASSERT_EQUAL(
        std::string(
            "edge(2,3).\n" "edge(2,5).\n" "edge(3,1).\n" "edge(3,4).\n"
            "edge(3,6).\n" "edge(7,8).\n" "edge(8,9).\n"
...
void TestInstantiation::test_gbie() {
    CPPUNIT_ASSERT_EQUAL(std::string("gt(-3,-4).\n"), ground(gbie()+gbie1(), {"gt(", "le("}));
    CPPUNIT_ASSERT_EQUAL(std::string("le(-18,-16).\n"), ground(gbie()+gbie2(), {"gt(", "le("}));
}

std::string TestInstantiation::strategicA1() const {
    return
...
std::string TestInstantiation::strategicB1() const {
    return
...
void TestInstantiation::test_strategicB() {
    CPPUNIT_ASSERT_EQUAL(
        std::string(
            "strategic(1).\n"
...
CPPUNIT_TEST_SUITE_REGISTRATION(TestInstantiation);
