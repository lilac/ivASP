...
struct Bound {
    ...
    void simplify(Term::DotsMap &dots, unsigned &auxNum);
    //! Rewrite arithmetics.
...
inline void Bound::simplify(Term::DotsMap &dots, unsigned &auxNum) {
    bound->simplify(dots, auxNum, false, false).update(bound);
}
